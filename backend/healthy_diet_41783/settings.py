"""
Django settings for healthy_diet_41783 project.
...
ROOT_URLCONF = 'healthy_diet_41783.urls'
...
WSGI_APPLICATION = 'healthy_diet_41783.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthy_diet_41783 API",
    "DESCRIPTION": "API documentation for healthy_diet_41783 App",
    "VERSION": "v1",
}
